...
from compressai.layers import RSTB, MultistageMaskedConv2d, RSTB_PromptModel, RSTB_svdlora
...
class TIC_svdlora(nn.Module):
    ...
    def __init__(self, N=128, M=192, prompt_config=None, input_resolution=(256,256)):
        ...
        self.mask_down = prompt_config.MASK_DOWNSAMPLE
        encblock = RSTB_svdlora

        self.g_a0 = conv(3, N, kernel_size=5, stride=2)
        self.g_a1 = RSTB_svdlora(dim=N,
                        input_resolution=(input_resolution[0]//2, input_resolution[1]//2),
                        depth=depths[0],
                        num_heads=num_heads[0],
                        window_size=window_size,
